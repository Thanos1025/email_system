...
public class MailServer {
	...
	public int addUser(String name, String emailAddress, String password) {
		...
		int inbox = addFolder(userId,"Inbox", true);
		int sent = addFolder(userId,"Sent", true);
		int draft = addFolder(userId,"Draft", true);
		int trash = addFolder(userId,"Trash", true);
	...
	public int addFolder(int userId, String folderName, Boolean isDefaultFolder) {
		int folderId = folders.size();
		folders.put(folderId, new Folder(folderId, userId, folderName, isDefaultFolder));
		return folderId;
	}
	...
	public int addEmail(String subject, String body, int senderId, List recipientIds) {
	...
	public void replyEmail(int emailId, int repliedEmailId) {
		Email email = getEmail(emailId);
		email.sendReplyEmail(repliedEmailId);
	}
